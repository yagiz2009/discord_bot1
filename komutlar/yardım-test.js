...
.setThumbnail(client.user.avatarURL)
      ...
      .addField('**Sunucu Komutları**', '`ses-kanal-aç`, `kanal-açıklama`, `rol-liste`, `temizle`, `yaz`, `mesajat`, `sil-üye`, `sil`, `vkanal`, `yasakla`, `yaz`')
      .addField('**Diğer Komutlar**', '`sunucu-kurulum`, `kara`, `eval`, `reboot`')
